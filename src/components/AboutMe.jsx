                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Image container */}
                            <div className={`relative w-80 h-80 md:w-96 md:h-96 rounded-3xl overflow-hidden border-2 ${theme === "dark"
                                ? "border-[#b8f2e6]/30 bg-[#1c1c1c]"
                                : "border-[#aed9e0]/50 bg-white"
                                }`}>
                                <motion.img
                                    src={theme === "dark" ? profilePicture : profilePicture}
                                    alt="Profile"
                            ...
                            <motion.div
                                ...
                                className={`absolute -top-4 -right-4 w-24 h-24 rounded-full border-4 opacity-40 ${theme === "dark" ? "border-[#b8f2e6]" : "border-[#aed9e0]"
                                    }`}
                            />
                            <motion.div
                                animate={{
                                ...
                                className={`absolute -bottom-6 -left-6 w-32 h-32 rounded-full border-4 opacity-30 ${theme === "dark" ? "border-[#b8f2e6]" : "border-[#aed9e0]"
                                    }`}
                            />
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        ...
                        >
                            <p className="text-xl md:text-2xl font-light">
                                Result-oriented Full Stack Developer with an MCA and expertise in building Autonomous AI Agents and scalable cloud applications.
                            </p>

                            <p className="text-base md:text-lg opacity-90">
                                Proficient in Next.js 15, Node.js, and PHP (Laravel), with a specialized focus on RAG (Retrieval-Augmented Generation). Experienced in Agile development and deploying containerized microservices using Docker and Kubernetes on AWS and GCP environments.
                            </p>
