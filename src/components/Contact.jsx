    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className={`absolute top-20 left-10 w-96 h-96 rounded-full blur-3xl opacity-10 ${theme === "dark" ? "bg-[#b8f2e6]" : "bg-[#aed9e0]"
            }`}
        />
        <motion.div
          animate={{
          ...
          className={`absolute bottom-20 right-10 w-96 h-96 rounded-full blur-3xl opacity-10 ${theme === "dark" ? "bg-[#b8f2e6]" : "bg-[#aed9e0]"
            }`}
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            <div>
              <h3 className={`text-3xl md:text-4xl font-bold mb-6 ${theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#5e6472]'
                }`}>
                Let's Connect
              </h3>
              <p className={`text-lg mb-8 ${theme === 'dark' ? 'text-[#aed9e0]' : 'text-[#5e6472]'
                } opacity-90`}>
            ...
            <div className="space-y-4">
              <motion.div
                ...
                className={`p-6 rounded-2xl backdrop-blur-sm border transition-all duration-300 ${theme === 'dark'
                  ? 'bg-[#b8f2e6]/10 border-[#b8f2e6]/20 hover:bg-[#b8f2e6]/20'
                  : 'bg-[#aed9e0]/20 border-[#aed9e0]/40 hover:bg-[#aed9e0]/30'
                  }`}
              >
                <div className="flex items-center space-x-4">
                  <div className={`p-3 rounded-xl ${theme === 'dark' ? 'bg-[#b8f2e6]/20' : 'bg-[#aed9e0]/50'
                    }`}>
                    <svg className={`w-6 h-6 ${theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#5e6472]'
                      }`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <div>
                    <p className={`text-sm opacity-75 ${theme === 'dark' ? 'text-[#aed9e0]' : 'text-[#5e6472]'
                      }`}>Phone</p>
                    <p className={`text-lg font-semibold ${theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#5e6472]'
                      }`}>+91-8075271705</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className={`text-lg font-semibold break-all ${theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#5e6472]'
                      }`}>nithinbabuofficialid@gmail.com</p>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="pt-6"
            >
              <p className={`text-sm mb-4 ${theme === 'dark' ? 'text-[#aed9e0]' : 'text-[#5e6472]'
                } opacity-75`}>
                Connect with me
              </p>
            ...
            <div className="space-y-6">
              {[
                ...
                >
                  <label
                    htmlFor={field.id}
                    className={`block text-sm font-medium mb-2 ${theme === 'dark' ? 'text-[#b8f2e6]' : 'text-[#5e6472]'
                      }`}
                  >
                    {field.label}
                  </label>
                  {field.type !== 'textarea' ? (
                    <motion.input
                      ...
                      className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-300 focus:outline-none focus:ring-2 ${theme === 'dark'
                        ? errors[field.id]
                    ...
                    <motion.textarea
                      ...
                      onChange={handleChange}
                      rows="5"
                      className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-300 focus:outline-none focus:ring-2 resize-none ${theme === 'dark'
                        ? errors[field.id]
                          ? 'border-red-500 bg-[#5e6472]/50 text-[#b8f2e6] focus:ring-red-500/50'
                          : 'border-[#b8f2e6]/30 bg-[#5e6472]/50 text-[#b8f2e6] focus:border-[#b8f2e6] focus:ring-[#b8f2e6]/30'
                        : errors[field.id]
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                disabled={isLoading}
                className={`w-full px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 relative overflow-hidden ${theme === 'dark'
      ...
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            className={`fixed bottom-8 right-8 px-6 py-4 rounded-2xl shadow-2xl backdrop-blur-sm z-50 flex items-center space-x-3 ${toast.type === 'success'
              ? theme === 'dark'
